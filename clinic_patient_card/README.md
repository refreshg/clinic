...
## Dependencies
`base, contacts, product, account, mail, calendar, stock, purchase, sale_management`
...
- **Per-dentist default room**: user form → *Clinic* tab → Default Room.
- **Catalog**: procedures = service products flagged *Clinic Procedure*; supplies flagged
  *Clinic Supply* (+ reordering rules for the low-stock alert); insurance companies =
  contacts flagged *Insurance Company*; rooms & appointment types under Clinic →
  Configuration.
...
## Known limitations
- E-mail sending: none yet — what/when is undecided (docs/PRD.md §9).
