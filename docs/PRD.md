...
- **რეცენზენტის batch #2 — Track B „მაღაზია/მარაგები" B1+B2 ✅ (v19.0.50–51, 2026-09-05;
  ...
  - **B3 მაღაზიის UX v2 ✅ (v19.0.52, 2026-09-11; პ.1–15):** კატეგორიები ფოტოებით +
    ქვეკატეგორიების ჩიპები (7 ქართული კატეგორია), ბანერები/დასპონსორებული/სიახლეები მთავარ
    გვერდზე, ბრენდ-ფილტრი, ბესთსელერები (90-დღიანი PO-ისტორია), პერსონალური Wishlist,
    Pre-order ბეჯი (მარაგის გარეშეც შეკვეთადი — მომხმ. არჩევანი), „ბოლო შეკვეთის გამეორება"
    რედაქტირებით, მსგავსი პროდუქტები ძიებაში, მომწოდებელთა ფასების შედარების ცხრილი.
  - **B4 მიღება/დაბრუნება/რეიტინგი/დეშბორდი ✅ (v19.0.53, 2026-09-11; პ.11-12, 16-41, 100-114):**
    მიმწოდებლის 5 სტატუსი საკუთარ ორდერზე ხელით (კურიერი არაა — მომხმ. გადაწყვეტილება) →
    კლინიკის ორდერზე ჩანაწერი+toast; მიღების ვალიდაციაზე vendor bill ავტო-დრაფტი (ზედნადები
    ხელით — მომხმ. არჩევანი); მიღებულ ორდერზე ★1-5 შეფასება (პროდუქტი/მომწოდებელი) —
    საშუალოები მაღაზიაშიც; დაბრუნება 48-საათიანი ღილაკით (მიზეზი სავალდებულო + ფოტო →
    მომწოდებლის განხილვა → დადასტურება=ავტო უკუ-გადაზიდვა / უარყოფა კომენტარით → გზაშია →
    დახურვა); მენეჯერის 📊 დეშბორდი 11 ბლოკით (102-114). გამოტოვებული: კურიერი (22, 39,
    101-ლოკაცია), ონლაინ გადახდა.
  - ამით ორივე რეცენზენტის დოკუმენტი (ჯავშნები + მაღაზიამარაგები) **სრულად დახურულია**.
- **მაღაზიამარაგების ტესტ-რაუნდის ფიქსები ✅ (v19.0.53.1–23, 2026-09-12):** კატეგორიების
  მენიუ Clinic-ში + „Show in Shop" კონტროლი + უსასრულო სიღრმის ქვეკატეგორიები; ბანერები —
  2 ფიქსირებული სლოტი, ჰიპერლინკი, ტექსტის ჩართვა/გამორთვა, 3+ ბანერზე წყვილის ტრიალი;
  ბრენდს/Pre-order-ს/მაღაზიაში ჩვენებას **მომწოდებელი** მართავს (My Shop); Sponsored-ის
  სამართავი სია კლინიკას + ბეჯი მომწოდებელსაც; ⇄ შედარების კალათა (მაქს 4, გვერდიგვერდ
  ცხრილი); კალათა/შედარება refresh-ს უძლებს; „შესაფასებელი" ჩანართი; დაბრუნების ჯაჭვის
  დასრულება (Returned—Close — მარაგი რეალურად გადის); Rating/Returns/ავტო-ინვოისი
  მოთხოვნის ორდერებზეც; მომწოდებლის წვდომა: კითხვა ღია / წერა საკუთარზე (D-20).
- **მომწოდებლის საკუთარი საწყობი ✅ (v19.0.54–55, 2026-09-12; D-19):** თითო მომწოდებელს
  ავტომატურად აქვს Suppliers/<სახელი> + „გზაში" თარო; მენიუები: My Locations (თაროები),
  ↔ Move Stock (შიდა გადატანა მხოლოდ საკუთარში), My Warehouse (დათვლა/Apply), My Transfers
  (ისტორია, read-only). **ჩამოკლება გაგზავნისას** (In Transit: საწყობი→გზაში), კლინიკის
  მიღება „გზაშიდან" იღებს; დაბრუნება მის საწყობში ბრუნდება; მაღაზიის მარაგი/Pre-order =
  მომწოდებლის საკუთარი ნაშთი. ძრავი 100% სტანდარტული stock-ია.
...
- ვიზუალური რედიზაინი (პაციენტის ფორმის Soft-UI + დაფის calendar_card სტილი, v55.2-.9) მომხმარებლის პირდაპირი მოთხოვნაა და AC-ებით არ იფარება — მიღება ბრაუზერული დათვალიერებით (2026-09-13).
- Dentos-პარიტეტის ბატჩი (ვიზიტი/კლიენტი/პროცედურები, v56–60, D-22) მომხმარებლის ვიდეო-რეფერენსებით დამტკიცებული გეგმითაა და AC-ებით არ იფარება — მიღება ცოცხალი ტესტით (2026-09-17). ვიდეო 12-53-30 ჯერ განუხილველია.
