...
- **რეცენზენტის batch #2 — Track A „ჯავშნები" ✅ (v19.0.47–49, 2026-09-03; `docs/ჯავშნები.docx`):**
  ...
  - ⏸ SMS (პროვაიდერი უცნობია).
- **რეცენზენტის batch #2 — Track A ტესტ-რაუნდის ფიქსები ✅ (v19.0.51.1–18, 2026-09-05):**
  პაციენტის ველი Subject-ის ადგილას სათაურის ზომით; თავისუფალი სლოტების ძიება მთლიანად
  კლიენტის დიალოგად (D-16: არაფერს ინახავს Save-მდე; მიმართულებით/ექიმით/თარიღით წინასწარ
  მოფილტრული, ექიმის ჩიპი მოხსნადი); ჯავშნის ტიპის ხანგრძლივობა HH:MM ფორმატში + არჩევაზე
  ყოველთვის ივსება; „+ Odoo meeting" დამალულია; Procedures ჯავშნის ეტაპზევე ჩანს;
  ფიზ.პირი/კომპანია გადამრთველი დაბრუნდა + „სამუშაო ადგილი" ქართულად; **შენახვა/გაუქმება
  ღილაკები ყველა ფორმაზე** მხოლოდ ცვლილებისას (D-17); ექიმის რეალიზაცია გახსნილია
  (user_id force + stock/account read-only ACL-ები).
- **რეცენზენტის batch #2 — Track B „მაღაზია/მარაგები" B1+B2 ✅ (v19.0.50–51, 2026-09-05;
  `docs/მაღაზიამარაგები.docx` პ.27–29, 42–99):**
  - **B1 საწყობი (პ.42–69):** ლოკაციების ხე WH/Stock/Cabinets — ყოველი ოთახის ავტო-ლოკაცია,
    Sterilization, Write-off/Damaged/Expired ჩამოწერის ლოკაციები; `product_expiry` (ვადები);
    ბრენდების ცნობარი + პროდუქტზე ბრენდი/საშ. თვიური მოხმარება/ბოლო შესყიდვის ფასი;
    per-ლოკაცია min/max; Clinic→Stock მენიუ (გადატანები/ჩამოწერა/მინ-მაქსი/სტრუქტურა) —
    ყველა მოძრაობა სტანდარტული stock.move-კვალით.
  - **B2 შესყიდვის მოთხოვნები (პ.70–99, 27–29):** clinic.purchase.request — 4 წყარო
    (ავტო-ალერტი/ექიმი/მენეჯერი/დაგეგმილი კალენდრით), 10 სტატუსი დოკის მიხედვით,
    უარყოფა სავალდებულო კომენტარით, მენეჯერის რეკომენდაციები ხაზზე (ნაშთი/სხვა
    კაბინეტები/მომწოდებელი/ბოლო ფასი/რეკომ. რაოდ.) + „გადანაწილება"; დამტკიცება→RFQ თითო
    მომწოდებელზე; **მარაგი იცვლება მხოლოდ მიღების ვალიდაციაზე** („მოტანილი ≠ მიღებული");
    დეფიციტის შემოსვლის ნოტიფიკაცია; ექიმებს „Supply Requests" (მხოლოდ საკუთარი).
  - 🔜 B3 მაღაზიის UX v2 (პ.1–16) — დაწყებულია (stash-შია), B4 მიღება/დაბრუნება/რეიტინგი/
    დეშბორდი (პ.17–41, 100–114; კურიერის გარეშე).
...
- **ხანგრძლივობა ტიპზე თუ სერვისზე (2026-09-05):** დარჩეს ჯავშნის ტიპების ცხრილში (ა) თუ
  გავიდეს ინვენთორის სერვის-პროდუქტის ბარათზე (ბ) — მომხმარებლის პასუხს ელოდება; მანამდე
  ტიპების ცხრილი რჩება (ა).
- batch #2 Track B (B1/B2) მომხმარებლის მიერ დამტკიცებული გეგმითაა და AC-ებით არ იფარება
  (ვარიანტი ა) — ბრაუზერული ტესტი მომხმარებელზეა.
