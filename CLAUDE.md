...
- **Append new `_inherit` classes at EOF** — a class inserted mid-file silently re-parents
  every def below it (broke the shop RFQ chain from v19.0.51 to .53); `grep '^class '` after
  structural edits.
